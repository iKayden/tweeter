$(document).ready(function () {
  $("#tweet-text").on("input", function (e) {
    ...
    // if user goes above the limit we will add class to make negative numbers
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop()) {
      //if it's at the top button will disappear
      $goUpBtn.fadeIn();
    } else {
      // if it's not at the top it will appear at the right bottom of the screen
      $goUpBtn.fadeOut();
    }
  });
  $goUpBtn.click(function () {
    //On click it will smoothly go to the top
